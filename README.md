...
No jogo, o sistema sorteia um número secreto entre 1 e 10 e oferece dicas (maior ou menor) até que o usuário acerte, garantindo que o mesmo número não seja sorteado repetidamente em rodadas consecutivas através do gerenciamento de listas (arrays).
Além disso, o projeto integra a API ResponsiveVoice para tornar a experiência mais acessível e dinâmica através de comandos de voz.
